...
class OwnerSignUp extends Component{
    ...
    render() {
        ...
        if(this.props.signupownerstatus){
        ...
        return (
            ...
            {redirectVar}
                ...
                <form class="form-signin">
                    ...
                    <div class="form-label-group">
                    <input type="text" id="restname" class="form-control" placeholder="Restaurant Name" required autoFocus/>
                    <label for="restname">Restaurant Name</label>
                    </div>
                    <div class="form-label-group">
                    <input type="text" id="restzip" class="form-control" placeholder="Zip" required autoFocus/>
                    <label for="restzip">Zip</label>
                    </div>
                    <div class="form-label-group">
                    <input type="text" id="cuisine" class="form-control" placeholder="Cuisine" required autoFocus/>
                    <label for="cuisine">Cuisine</label>
                    </div>
                    <div class="form-label-group">
                    <input type="text" id="mob" class="form-control" placeholder="Contact" required autoFocus/>
